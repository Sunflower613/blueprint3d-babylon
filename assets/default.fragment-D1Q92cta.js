import{S as e}from"./app-DSJ_ZURW.js";import"./mainUVVaryingDeclaration-_hHbQI05.js";import"./helperFunctions-iQgP4Ey2.js";import"./clipPlaneFragment-6LptLChc.js";import"./logDepthDeclaration-CpoVdjBU.js";import"./fogFragment-BSCldDMy.js";import"./logDepthFragment-BEljwsMG.js";import"./index-CcqAbjAb.js";import"./meshUboDeclaration-DqjiRxHO.js";const t="prePassDeclaration",C=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=T);const o="lightUboDeclaration",L=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=I);const f="lightsFragmentFunctions",E=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=X);const c="imageProcessingDeclaration",M=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=M);const v="imageProcessingFunctions",N=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=N);const u="bumpFragmentMainFunctions",_=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=_);const p="bumpFragmentFunctions",y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=y);const h="bumpFragment",R=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=R);const m="decalFragment",F=`#ifdef DECAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=w);const q={name:r,shader:w};export{q as defaultPixelShaderWGSL};
